# Contributing to ruff-fix-and-commit
...
Found a bug or have a feature request? [Open an issue](https://github.com/tsvikas/ruff-fix-and-commit/issues/new) on GitHub.

### 💬 Join Discussions

Have questions or ideas? Join the conversation in [GitHub Discussions](https://github.com/tsvikas/ruff-fix-and-commit/discussions).
...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/tsvikas/ruff-fix-and-commit.git
   ```

1. Set up the development environment:

   ```bash
   cd ruff-fix-and-commit
   uv run just prepare
   ```
